...
# Register custom function for Keras serialization
...
def Siamese_CNN():
   ...
   # Use subtract layer instead of Lambda to avoid deserialization issues
   from keras.layers import Subtract
   distance = Subtract()([processed_1, processed_2])
   distance = Lambda(abs_fn, output_shape=(4096,))(distance)
